...
class PandaEnv(gym.Env):
    ...
    def step(self, action):
        ...
        tau_disturbance = np.matmul(J[:3, :].T, self.disturbance)
       
        # ... (Gravity & Damping same as before) ...
        tau_grav = self.panda.getNonlinearities(self.world.getGravity())
        self.panda.setGeneralizedForce(tau_action + tau_grav + tau_disturbance)
    ...
    def set_disturbance(self, force_vec):
        self.disturbance = np.array(force_vec)